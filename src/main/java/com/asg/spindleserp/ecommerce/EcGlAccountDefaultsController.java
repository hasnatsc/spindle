 ...
 */
@Controller
@RequestMapping("/ecommerce/gl-defaults")
...
public class EcGlAccountDefaultsController {
    ...
    public String index(Model m) {
        m.addAttribute("activePage", "ec-gl-defaults");
        return "ecommerce/ec-gl-defaults";
    }
    ...
    public Map<String, Object> load() {
        ...
        try {
            ...
            res.put("obj", glService.findOrCreateByOrg(orgId));
        } catch (Exception e) {
    ...
    @PostMapping("/save")
    @ResponseBody
    public Map<String, Object> save(@RequestBody EcGlAccountDefaultsDTO dto) {
        Map<String, Object> res = new HashMap<>();
        try {
            glService.save(dto);
            res.put("success", true);
            res.put("message", "GL account defaults saved.");
        } catch (Exception e) {
            res.put("success", false);
            res.put("message", e.getMessage());
        }
