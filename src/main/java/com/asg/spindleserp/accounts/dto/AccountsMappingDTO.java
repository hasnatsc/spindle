...
public class AccountsMappingDTO {
    ...
    private String defaultDebitAccountDisplay;
    private Long defaultCreditAccountId;
    private String defaultCreditAccountDisplay;
    private Long discountAccountId;
    private String discountAccountDisplay;
    private Long freightAccountId;
    private String freightAccountDisplay;
    private Long inputVatAccountId;
    private String inputVatAccountDisplay;
    private Long outputVatAccountId;
    private String outputVatAccountDisplay;
    private Long forexGainAccountId;
    private String forexGainAccountDisplay;
    private Long forexLossAccountId;
    private String forexLossAccountDisplay;
    private Long tdsAccountId;
    private String tdsAccountDisplay;
    private Long aitAccountId;
    private String aitAccountDisplay;
    private Long roundingAccountId;
    private String roundingAccountDisplay;
