...
public class ChartOfAccountSubDTO {
    ...
    @Size(max = 20)
    private String bankAccountType;    // SAVINGS | CURRENT | STD
    @Size(max = 100)
    ...
    @Size(max = 30)
    private String lcType;      // BTB | MASTER | SIGHT | USANCE
    @Size(max = 30)
    private String lcStatus;    // OPEN | SHIPPED | SETTLED | EXPIRED | CANCELLED
    @Size(max = 20)
