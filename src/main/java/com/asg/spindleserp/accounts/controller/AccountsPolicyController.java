...
public class AccountsPolicyController {
    ...
    public Map<String, Object> show(@PathVariable Long id) {
        ...
        try {
            ...
            res.put("obj", Map.of("defaultData", policyService.findById(id)));
        } catch (Exception e) {
    ...
    public Map<String, Object> save(@RequestBody @Valid AccountsPolicyDTO dto) {
        ...
        try {
            if (dto.getId() != null) {
                policyService.update(dto.getId(), dto);
                res.put("message", "Policy updated.");
            } else {
                policyService.create(dto);
                res.put("message", "Policy created.");
            }
            res.put("success", true);
        } catch (Exception e) {
            res.put("success", false);
    ...
    public Map<String, Object> delete(@PathVariable Long id) {
        ...
        try {
            ...
            res.put("success", true);
            res.put("message", "Policy deleted.");
        } catch (Exception e) {
            res.put("success", false);
            res.put("message", e.getMessage());
        }
