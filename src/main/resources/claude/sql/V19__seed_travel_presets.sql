...
VALUES
    ('HT-DHK-001', 'The Pan Pacific Sonargaon',   'Dhaka',    'Bangladesh', '107 Kazi Nazrul Islam Ave, Dhaka 1215',     5, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = '5 Star'), '+880-2-55512345', 'reservations@panpacific.dhaka.com', true, 1, NOW(), 'system'),
    ('HT-DHK-002', 'Hotel InterContinental Dhaka','Dhaka',    'Bangladesh', '1 Minto Rd, Dhaka 1000',                    5, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = '5 Star'), '+880-2-55663000', 'dhaka@intercontinental.com', true, 1, NOW(), 'system'),
    ('HT-DHK-003', 'Six Seasons Hotel',           'Dhaka',    'Bangladesh', '5/B, Road 99, Gulshan 2, Dhaka 1212',      5, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = '5 Star'), '+880-2-58811200', 'reservations@sixseasons.com', true, 1, NOW(), 'system'),
    ('HT-COX-001', 'Ocean Paradise Hotel',        'Cox''s Bazar', 'Bangladesh', 'Hotel Motel Zone, Cox''s Bazar 4700',     4, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = '4 Star'), '+880-341-52345', 'info@oceanparadise.com', true, 1, NOW(), 'system'),
    ('HT-COX-002', 'Royal Tulip Sea Pearl',       'Cox''s Bazar', 'Bangladesh', 'Sugandha Point, Cox''s Bazar 4700',      5, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = '5 Star'), '+880-341-62345', 'reservations@royaltulip.com', true, 1, NOW(), 'system'),
    ('HT-COX-003', 'Hotel Media Cox',             'Cox''s Bazar', 'Bangladesh', '4no Ghat, Main Road, Cox''s Bazar',      3, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = '3 Star'), '+880-341-52346', 'info@hotelmediacox.com', true, 1, NOW(), 'system'),
    ('HT-SYL-001', 'Grand Sultan Tea Resort',     'Sylhet',   'Bangladesh', 'Mugla Para, Upashahar, Sylhet',             5, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = 'Resort'), '+880-821-72345', 'reservations@grandsultan.com', true, 1, NOW(), 'system'),
    ('HT-SYL-002', 'Rose View Hotel',             'Sylhet',   'Bangladesh', 'Sylhet 3100, Shahjalal Upashahar',          4, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = '4 Star'), '+880-821-71777', 'info@roseviewhotel.com', true, 1, NOW(), 'system'),
    ('HT-SG-001',  'Hotel Agrabad',               'Chittagong','Bangladesh', 'Agrabad C/A, Chittagong 4100',             4, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = '4 Star'), '+880-31-713311', 'info@hotelagrabad.com', true, 1, NOW(), 'system'),
    ('HT-KH-001',  'Nilgiri Hill Resort',         'Bandarban','Bangladesh', 'Nilgiri, Bandarban Hill District',           3, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = 'Resort'), '+880-371-41234', 'nilgiri@resort.com', true, 1, NOW(), 'system'),
    ('HT-KH-002',  'Hill Side Resort',            'Rangamati','Bangladesh', 'Tabalchari, Rangamati',                    3, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = 'Resort'), '+880-352-51234', 'hillside@rangamati.com', true, 1, NOW(), 'system'),
    ('HT-KL-001',  'Hotel Castle Salam',          'Khulna',   'Bangladesh', '2 KDA Ave, Khulna 9100',                   3, (SELECT id FROM trv_hotel_categories WHERE organization_id = 1 AND category_name = '3 Star'), '+880-41-720123', 'info@castlesalam.com', true, 1, NOW(), 'system')
