...
INSERT INTO acc_mapping_details (accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, organization_id, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
...
INSERT INTO acc_mapping_details (accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, tax_code, tax_rate, organization_id, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
...
INSERT INTO acc_mapping_details (accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, tax_code, organization_id, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '1000')
  AND NOT EXISTS (
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '1111')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '1112')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '1115')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '1200')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '1310')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '1330')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '2000')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '2110')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '2210')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '3000')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '3300')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '4000')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
...
WHERE EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '5000')
  AND NOT EXISTS (
    SELECT 1 FROM acc_opening_balances ob
    WHERE ob.organization_id = 1
