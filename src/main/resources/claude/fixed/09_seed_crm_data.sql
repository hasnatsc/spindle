...
SELECT
    ...
    1, (SELECT id FROM sec_users WHERE username = 'sales.manager'), NULL, NOW(), NOW(), 'system', 'system'
...
SELECT
    ...
    1, (SELECT id FROM sec_users WHERE username = 'sales.executive'), NULL, NOW(), NOW(), 'system', 'system'
ON CONFLICT ON CONSTRAINT uq_crl_org_no DO NOTHING;
...
SELECT
    ...
    1, (SELECT id FROM sec_users WHERE username = 'sales.manager'), cust.id, NOW(), NOW(), 'system', 'system'
FROM acc_chart_of_accounts_sub cust
WHERE cust.sub_account_code = 'CUST-0001' AND cust.organization_id = 1
ON CONFLICT ON CONSTRAINT uq_crl_org_no DO NOTHING;
...
SELECT
    ...
    1, (SELECT id FROM sec_users WHERE username = 'sales.manager'), cust.id, ld.id, NOW(), NOW(), 'system', 'system'
FROM acc_chart_of_accounts_sub cust, crm_leads ld
WHERE cust.sub_account_code = 'CUST-0001' AND cust.organization_id = 1
...
SELECT
    ...
    1, (SELECT id FROM sec_users WHERE username = 'sales.executive'), NULL, ld.id, NOW(), NOW(), 'system', 'system'
FROM crm_leads ld
WHERE ld.lead_no = 'LEAD-0002' AND ld.organization_id = 1
ON CONFLICT ON CONSTRAINT uq_cro_org_no DO NOTHING;
...
SELECT
    ...
    1, (SELECT id FROM sec_users WHERE username = 'sales.manager'), cust.id, NULL, NOW(), NOW(), 'system', 'system'
FROM acc_chart_of_accounts_sub cust
WHERE cust.sub_account_code = 'CUST-0001' AND cust.organization_id = 1
ON CONFLICT ON CONSTRAINT uq_cro_org_no DO NOTHING;
...
FROM acc_chart_of_accounts_sub cust WHERE cust.sub_account_code = 'CUST-0001' AND cust.organization_id = 1
  AND NOT EXISTS (SELECT 1 FROM crm_contacts c WHERE c.customer_id = cust.id AND c.email = 'karim@abctrading.com');
...
FROM acc_chart_of_accounts_sub cust WHERE cust.sub_account_code = 'CUST-0001' AND cust.organization_id = 1
  AND NOT EXISTS (SELECT 1 FROM crm_contacts c WHERE c.customer_id = cust.id AND c.email = 'liza@abctrading.com');
...
SELECT
    ...
    1, (SELECT id FROM sec_users WHERE username = 'sales.manager'), NULL, ld.id, NULL,
    NOW(), NOW(), 'system', 'system'
FROM crm_leads ld
WHERE ld.lead_no = 'LEAD-0001' AND ld.organization_id = 1
  AND NOT EXISTS (SELECT 1 FROM crm_activities x WHERE x.organization_id = 1 AND x.subject = 'Initial discovery call' AND x.activity_date = DATE '2026-06-05');
...
SELECT
    ...
    1, (SELECT id FROM sec_users WHERE username = 'sales.executive'), NULL, NULL, opp.id,
    NOW(), NOW(), 'system', 'system'
FROM crm_opportunities opp
WHERE opp.opportunity_no = 'OPP-0002' AND opp.organization_id = 1
  AND NOT EXISTS (SELECT 1 FROM crm_activities x WHERE x.organization_id = 1 AND x.subject = 'Pricing negotiation meeting' AND x.activity_date = DATE '2026-06-10');
...
SELECT
    ...
    1, (SELECT id FROM sec_users WHERE username = 'sales.manager'), cust.id, NULL, opp.id,
    NOW(), NOW(), 'system', 'system'
FROM acc_chart_of_accounts_sub cust, crm_opportunities opp
WHERE cust.sub_account_code = 'CUST-0001' AND cust.organization_id = 1
  AND opp.opportunity_no = 'OPP-0003' AND opp.organization_id = 1
  AND NOT EXISTS (SELECT 1 FROM crm_activities x WHERE x.organization_id = 1 AND x.subject = 'Quarterly check-in' AND x.activity_date = DATE '2026-06-14');
...
SELECT
    ...
    NULL, 'PLANNED',
    90, NULL, NULL,
    1, (SELECT id FROM sec_users WHERE username = 'sales.executive'), NULL, ld.id, opp.id,
    NOW(), NOW(), 'system', 'system'
FROM crm_leads ld, crm_opportunities opp
WHERE ld.lead_no = 'LEAD-0002' AND ld.organization_id = 1
  AND opp.opportunity_no = 'OPP-0002' AND opp.organization_id = 1
  AND NOT EXISTS (SELECT 1 FROM crm_activities x WHERE x.organization_id = 1 AND x.subject = 'Site visit — Greenfield Apparels' AND x.activity_date = DATE '2026-06-25');
...
FROM acc_chart_of_accounts_sub cust WHERE cust.sub_account_code = 'CUST-0001' AND cust.organization_id = 1
  AND NOT EXISTS (SELECT 1 FROM crm_customer_feedback f WHERE f.organization_id = 1 AND f.subject = 'Late delivery complaint' AND f.feedback_date = DATE '2026-05-20');
...
SELECT
    ...
    1, cust.id, NOW(), NOW(), 'system', 'system'
FROM acc_chart_of_accounts_sub cust WHERE cust.sub_account_code = 'CUST-0001' AND cust.organization_id = 1
  AND NOT EXISTS (SELECT 1 FROM crm_customer_feedback f WHERE f.organization_id = 1 AND f.subject = 'Positive feedback on product quality' AND f.feedback_date = DATE '2026-06-01');
