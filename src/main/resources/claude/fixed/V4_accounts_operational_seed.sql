...
-- ── SAFETY GUARD ─────────────────────────────────────────────────────────────
-- This file references the full chart of accounts (codes 1310, 2110, 1151,
-- 4110, 2311, ...) from the complete COA seed. Running it against a different
-- COA (e.g. the minimal 05_seed_chart_of_accounts codes, where 1200 = Fixed
-- Assets group) would silently create mappings pointing at the wrong ledgers.
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM acc_chart_of_accounts WHERE account_code = '1310' AND organization_id = 1) THEN
        RAISE EXCEPTION 'V4 accounts operational seed aborted: full chart of accounts not loaded (account 1310 missing). Load the complete COA seed first.';
    END IF;
END $$;
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
...
SELECT 1, m.id, 1, 1, 'DEBIT', 'Inventory Debit', 'Debit inventory for purchase amount',
    'SUBTOTAL',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, tax_code, tax_rate, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 2, 2, 'DEBIT', 'Input VAT', 'Input VAT on purchase (15%)',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 3, 3, 'DEBIT', 'Freight In', 'Freight and delivery charges on purchase',
    'FIELD_VALUE',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 4, 4, 'CREDIT', 'Purchase Discount', 'Discount received from supplier',
    'FIELD_VALUE',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 5, 5, 'CREDIT', 'Accounts Payable', 'Net payable to supplier',
    'BALANCE',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 1, 1, 'DEBIT', 'Accounts Receivable', 'Amount due from customer including VAT',
    'BALANCE',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 2, 2, 'CREDIT', 'Sales Revenue', 'Revenue from goods/services sold',
    'SUBTOTAL',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, tax_code, tax_rate, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 3, 3, 'CREDIT', 'Output VAT', 'VAT collected from customer (15%)',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 4, 4, 'DEBIT', 'Sales Discount', 'Discount given to customer',
    'FIELD_VALUE',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 5, 5, 'CREDIT', 'Freight Revenue', 'Delivery and shipping charges billed',
    'FIELD_VALUE',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 1, 1, 'DEBIT', 'Accounts Payable', 'Reduce supplier outstanding balance',
    'FULL_AMOUNT',
    (SELECT id FROM acc_chart_of_accounts WHERE account_code = '2110'),
    TRUE, FALSE, FALSE, FALSE, TRUE, FALSE,
    FALSE, 'SUPPLIER', 'SYSTEM', NOW(), NOW()
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 2, 2, 'CREDIT', 'Bank Account', 'Reduce bank balance on payment',
    'FULL_AMOUNT',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 1, 1, 'DEBIT', 'Bank Account', 'Increase bank balance on customer receipt',
    'FULL_AMOUNT',
    (SELECT id FROM acc_chart_of_accounts WHERE account_code = '1115'),
    TRUE, FALSE, FALSE, FALSE, TRUE, FALSE,
    FALSE, 'BANK', 'SYSTEM', NOW(), NOW()
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 2, 2, 'CREDIT', 'Accounts Receivable', 'Reduce customer outstanding balance',
    'FULL_AMOUNT',
    (SELECT id FROM acc_chart_of_accounts WHERE account_code = '1200'),
    TRUE, FALSE, FALSE, FALSE, TRUE, FALSE,
    FALSE, 'CUSTOMER', 'SYSTEM', NOW(), NOW()
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 1, 1, 'DEBIT', 'Depreciation Expense', 'Monthly depreciation charge',
    'FORMULA',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 2, 2, 'CREDIT', 'Accumulated Depreciation', 'Accumulated depreciation on asset',
    'FORMULA',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 1, 1, 'DEBIT', 'Salaries & Wages', 'Gross salary expense',
    'FULL_AMOUNT',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, tax_code, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 2, 2, 'CREDIT', 'Employee Tax Withheld', 'Income tax deducted from salary',
...
INSERT INTO acc_mapping_details (organization_id, accounts_mapping_id, line_number, sort_order, entry_type, entry_name, entry_description,
    amount_type, account_id, is_active, is_optional, is_tax_entry, negate_amount, round_amount, skip_if_zero,
    inherit_cost_center, control_account_type, created_by, created_at, updated_at)
SELECT 1, m.id, 3, 3, 'CREDIT', 'Net Salaries Payable', 'Net salary payable after deductions',
    'BALANCE',
...
INSERT INTO acc_policy (organization_id, policy_code, policy_name, policy_type, module_type, is_active, is_default,
    is_system, allow_backdating, backdating_days, allow_future_dating, allow_edit_after_post,
    allow_reversal, allow_negative_amount, allow_zero_amount, auto_numbering, voucher_prefix,
    number_padding, next_voucher_number, require_approval, auto_post, approval_threshold,
    default_narration_template, description, created_by, created_at, updated_at)
SELECT 1, 'POL_JV', 'Journal Voucher Policy', 'JOURNAL_VOUCHER', 'GENERAL_LEDGER', TRUE, TRUE, TRUE,
    TRUE, 30, FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, 'JV', 6, 1, FALSE, FALSE, 0,
...
INSERT INTO acc_policy (organization_id, policy_code, policy_name, policy_type, module_type, is_active, is_default,
    ...
    number_padding, next_voucher_number, require_approval, auto_post, approval_threshold,
    default_narration_template, description, created_by, created_at, updated_at)
SELECT 1, 'POL_PV', 'Payment Voucher Policy', 'PAYMENT_VOUCHER', 'ACCOUNTS_PAYABLE', TRUE, TRUE, TRUE,
    TRUE, 7, FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, 'PV', 6, 1, TRUE, FALSE, 50000,
...
INSERT INTO acc_policy (organization_id, policy_code, policy_name, policy_type, module_type, is_active, is_default,
    ...
    number_padding, next_voucher_number, require_approval, auto_post, approval_threshold,
    default_narration_template, description, created_by, created_at, updated_at)
SELECT 1, 'POL_RV', 'Receipt Voucher Policy', 'RECEIPT_VOUCHER', 'ACCOUNTS_RECEIVABLE', TRUE, TRUE,
    TRUE, TRUE, 7, FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, 'RV', 6, 1, FALSE, FALSE, 0,
...
INSERT INTO acc_policy (organization_id, policy_code, policy_name, policy_type, module_type, is_active, is_default,
    ...
    number_padding, next_voucher_number, require_approval, auto_post, approval_threshold,
    default_narration_template, description, created_by, created_at, updated_at)
SELECT 1, 'POL_CV', 'Contra Voucher Policy', 'CONTRA_VOUCHER', 'CASH_MANAGEMENT', TRUE, TRUE, TRUE,
    TRUE, 3, FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, 'CV', 6, 1, TRUE, FALSE, 100000,
...
INSERT INTO acc_policy (organization_id, policy_code, policy_name, policy_type, module_type, is_active, is_default,
    ...
    number_padding, next_voucher_number, require_approval, auto_post, approval_threshold,
    default_narration_template, description, created_by, created_at, updated_at)
SELECT 1, 'POL_PURV', 'Purchase Voucher Policy', 'PURCHASE_VOUCHER', 'PURCHASE', TRUE, TRUE, TRUE,
    TRUE, 15, FALSE, FALSE, TRUE, FALSE, FALSE, TRUE, 'PURV', 6, 1, TRUE, FALSE, 100000,
...
INSERT INTO acc_policy (organization_id, policy_code, policy_name, policy_type, module_type, is_active, is_default,
    ...
    number_padding, next_voucher_number, require_approval, auto_post, approval_threshold,
    default_narration_template, description, created_by, created_at, updated_at)
SELECT 1, 'POL_SALV', 'Sales Voucher Policy', 'SALES_VOUCHER', 'SALES', TRUE, TRUE, TRUE, TRUE, 7,
    TRUE, FALSE, TRUE, FALSE, FALSE, TRUE, 'SALV', 6, 1, FALSE, TRUE, 0,
    'Sales Invoice #{voucherNumber} to {partyName}', 'Policy for sales invoices and AR vouchers',
    'SYSTEM', NOW(), NOW()
...
INSERT INTO acc_policy (organization_id, policy_code, policy_name, policy_type, module_type, is_active, is_default,
    ...
    number_padding, next_voucher_number, require_approval, auto_post, approval_threshold,
    default_narration_template, description, created_by, created_at, updated_at)
SELECT 1, 'POL_DN', 'Debit Note Policy', 'DEBIT_NOTE', 'PURCHASE', TRUE, TRUE, TRUE, TRUE, 30, FALSE,
    FALSE, FALSE, FALSE, FALSE, TRUE, 'DN', 6, 1, TRUE, FALSE, 0,
    'Debit Note #{voucherNumber} to {partyName}', 'Policy for purchase return debit notes',
    'SYSTEM', NOW(), NOW()
...
INSERT INTO acc_policy (organization_id, policy_code, policy_name, policy_type, module_type, is_active, is_default,
    ...
    number_padding, next_voucher_number, require_approval, auto_post, approval_threshold,
    default_narration_template, description, created_by, created_at, updated_at)
SELECT 1, 'POL_CN', 'Credit Note Policy', 'CREDIT_NOTE', 'SALES', TRUE, TRUE, TRUE, TRUE, 30, FALSE,
    FALSE, FALSE, FALSE, FALSE, TRUE, 'CN', 6, 1, TRUE, FALSE, 0,
    'Credit Note #{voucherNumber} to {partyName}', 'Policy for sales return credit notes', 'SYSTEM',
    NOW(), NOW()
...
INSERT INTO acc_policy (organization_id, policy_code, policy_name, policy_type, module_type, is_active, is_default,
    ...
    number_padding, next_voucher_number, require_approval, auto_post, approval_threshold,
    default_narration_template, description, created_by, created_at, updated_at)
SELECT 1, 'POL_EXP', 'Expense Voucher Policy', 'EXPENSE_VOUCHER', 'GENERAL_LEDGER', TRUE, TRUE, TRUE,
    TRUE, 7, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, 'EXP', 6, 1, TRUE, FALSE, 10000,
    'Expense #{voucherNumber} dated {voucherDate}', 'Policy for expense and petty cash vouchers',
    'SYSTEM', NOW(), NOW()
...
-- Root: ASSETS (1000)
INSERT INTO acc_opening_balances (organization_id, account_id, accounting_period_id,
